def convert_text(text, font):
    font = font.lower()
    variant = the_stupid_fonts[font][1]
...
# font name(lower case) : ( replacement font, variant map )
the_stupid_fonts = {
    'mac c swiss': ('Arial', variant1),
    'mac c times': ('Times New Roman', variant1),
    'makcirh'    : ('Arial', variant1),
    'macedonian helv': ('Arial', variant1),
    'macedonian helvetika': ('Arial', variant1),
    'makedonska helvetika': ('Arial', variant1),
    'macedonian ancient': ('Arial', variant1),
    'macedonian penguin': ('Arial', variant1),
    'macedonian tms': ('Times New Roman', variant1),
    'makedonski tajms': ('Times New Roman', variant1),
    'mak_hebar': ('Arial', variant1),
    'mak_puls_helvetika': ('Arial', variant1),
    'mak_puls_times': ('Times New Roman', variant1),
    'mak_times': ('Times New Roman', variant1),
    'sans_k'     : ('Arial', variant2),
}
